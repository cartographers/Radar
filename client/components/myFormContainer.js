  ...
  return (
    <div>
      <Modal show={props.customDisplayForm}>
        ...
        <Modal.Footer>
          <Button onClick={props.showCustomForm}>
            Close
                    </Button>
        </Modal.Footer>
      </Modal>
    ...
    <div>
      <div className="col-md-12">
        ...
        <div className="queryDiv">
          <button onClick={props.showForm} className="queryButton btn-primary">
            Query Selection Form
                    </button>
          {props.displayForm ? <SelectQueryOptions {...props} /> : null}
        </div>
        <div className="queryDiv">
          <button onClick={props.showCustomForm} className="queryButton btn-primary">
            Advanced Query Form
                  </button>
